...
const settings = ["signUp", "signIn", "logOut"];
...
export function Header() {
  ...
  //   useEffect(() => {
  //     fetch("https://api.yourwebsite.com/cart")
  ...
  //       });
  //   }, []);
  //   const totalQuantity = cartData.products.quantity;
  //   const firstLetter = cartData.email.charAt(0).toUpperCase()
